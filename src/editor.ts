	...
	implements LovelaceCardEditor
{
	...
	private static readonly HELP_TEXT: Record<string, string> = {
		...
		glow:
			'Enable neon glow effects: glowing flow lines with comet trails, energy pulse waves, pulsing nodes, a glass card with ambient glow, and a battery SOC ring.',
		glow_intensity: 'Strength of the neon glow bloom (1 = subtle, 5 = intense).',
		glow_theme:
